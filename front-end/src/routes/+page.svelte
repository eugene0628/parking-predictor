...
<div class="grid-container">
    <h1 class="title">
        Parking Prediction Frontend
    </h1>
    <div class="action-container">
        <input class="arrival-input" placeholder="Minutes" type="number" min=0 bind:value={inputNum}/>
        <button on:click={sendRequest} class="send-button">
            Send
        </button>
    </div>
    <div class="output">
